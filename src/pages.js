...
async function pageStudy(req,res){
    const filters=req.query//recebe e manda de voltaas informaçoes hora materia etc mantem
...
async function saveClasses(req,res){
   ...
   const  proffyValue ={
    ...
    //classSchedules recebe multiplos valores em ARRAY POR ISSO E TRATADO DE FORMA DIFERENTE
